...
locals {
  ...
  cluster_output_gke_backup_agent_config_enabled    = google_container_cluster.primary.addons_config.0.gke_backup_agent_config.0.disabled
  ...
  cluster_gke_backup_agent_config_enabled    = !local.cluster_output_gke_backup_agent_config_enabled
